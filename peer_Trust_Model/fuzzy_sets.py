...
def own_T1FS_plot(*sets, title=None, legends=None, filename=None,
    ...
    *sets:
    ...
    if legends is not None:
        ...
        plt.legend(legends, bbox_to_anchor=(0, 1.02, 1, 0.2),
                   loc="upper left", mode="expand", ncol=n_colums)
...
def trust_fuzzy_set(trust_score):
    ...
    if trust_score <= 0.175:
        untrustworthy = trapezoid_mf(
            linspace(trust_score, trust_score, 100), [-1, 0., 0.05, 0.175, 1.])
        little_trustworthy = trapezoid_mf(linspace(trust_score, trust_score, 100), [
                                          0.05, 0.175, 0.3, 0.425, 1.])
        ...
        little_trustworthy = trapezoid_mf(linspace(trust_score, trust_score, 100), [
                                          0.05, 0.175, 0.3, 0.425, 1.])
        moderately_trustworthy = trapezoid_mf(
            linspace(trust_score, trust_score, 100), [0.3, 0.425, 0.55, 0.675, 1.])
        ...
        moderately_trustworthy = trapezoid_mf(
            linspace(trust_score, trust_score, 100), [0.3, 0.425, 0.55, 0.675, 1.])
        trustworthy = trapezoid_mf(linspace(trust_score, trust_score, 100), [
                                   0.55, 0.675, 0.8, 0.925, 1.])
        ...
        trustworthy = trapezoid_mf(linspace(trust_score, trust_score, 100), [
                                   0.55, 0.675, 0.8, 0.925, 1.])
        full_trustworthy = trapezoid_mf(linspace(trust_score, trust_score, 100), [
                                        0.8, 0.925, 1.05, 1.175, 1.])
...
def violation_fuzzy_set(new_SLAViolations, historical_SLA_violation_rate):
    ...
    domain_1 = linspace(historical_SLA_violation_rate/2,
                        historical_SLA_violation_rate*2, 100)
    domain_2 = linspace(historical_SLA_violation_rate*1.5,
                        historical_SLA_violation_rate*3, 100)

    mySet = T1FS(domain, trapezoid_mf,
                 [-1, 0., historical_SLA_violation_rate/2, historical_SLA_violation_rate, 1.])
    mySet_1 = T1FS(domain_1, trapezoid_mf, [historical_SLA_violation_rate/2, historical_SLA_violation_rate,
                   historical_SLA_violation_rate*1.5, historical_SLA_violation_rate*2, 1.])
    mySet_2 = T1FS(domain_2, trapezoid_mf, [historical_SLA_violation_rate*1.5, historical_SLA_violation_rate *
                   2, historical_SLA_violation_rate*2.5, historical_SLA_violation_rate*3, 1.])
    ...
    momentary = trapezoid_mf(linspace(new_SLAViolations, new_SLAViolations, 100), [
                             -1, 0., historical_SLA_violation_rate/2, historical_SLA_violation_rate, 1.])
    recurrent = trapezoid_mf(linspace(new_SLAViolations, new_SLAViolations, 100), [
                             historical_SLA_violation_rate/2, historical_SLA_violation_rate, historical_SLA_violation_rate*1.5, historical_SLA_violation_rate*2, 1.])
    persistent = trapezoid_mf(linspace(new_SLAViolations, new_SLAViolations, 100), [
                              historical_SLA_violation_rate*1.5, historical_SLA_violation_rate*2, historical_SLA_violation_rate*2.5, historical_SLA_violation_rate*3, 1.])
