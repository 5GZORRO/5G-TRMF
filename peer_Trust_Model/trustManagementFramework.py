...
class start_data_collection(Resource):
    ...
    def post(self):
        ...
        cold_start_info = self.consumer.start_reading_cold_start(max_previous_interactions_DLT)
        ...
        if len(list_product_offers)>1 and not bool(cold_start_info):
            ...
            for trustee in cold_start_info:
                aux_offers = []
                for offer in cold_start_info[trustee]:
                   aux_offers.append(offer)

                if aux_offers not in peerTrust.list_additional_did_offers:
                    peerTrust.list_additional_did_offers.append(aux_offers)
